...
class Line_Item {
    ...
    public function __toString() {
	    return "You chose " . $this->quantity . " order(s) of " . $this->item->name . ", " . $this->item->description . " With " . $this->toppings->quantity . " " . $this->toppings->type->name . "s. Price for this item: " . $this->item->price . " Order Subtotal: " . $this->subtotal . "Order Total: " . $this->getTotal . ".";
    }
